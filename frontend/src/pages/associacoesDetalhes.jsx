...
const AssociacaoDetalhes = () => {
  ...
  useEffect(() => {
    fetch(`https://api.jf-figueiredo.com/api/associacoes/${id}`)
      .then((res) => {
      ...
      <img
        src={
          associacao.media.file
            ? `https://api.jf-figueiredo.com/uploads/${associacao.media.file}`
            : `https://api.jf-figueiredo.com/uploads/${associacao.media}`
        }
