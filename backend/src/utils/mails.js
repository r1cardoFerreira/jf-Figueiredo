    ...
    <div style="font-family: Arial, sans-serif; padding: 20px; background-color: #f9f9f9;">
      ...
      <table style="width: 100%; border-collapse: collapse;">
        <tr>
          ...
          <td style="padding: 8px;">${dadosHtml.nome}</td>
        </tr>
        <tr>
          <td style="padding: 8px; font-weight: bold;">Email:</td>
          <td style="padding: 8px;">${dadosHtml.email}</td>
        </tr>
        <tr>
          <td style="padding: 8px; font-weight: bold;">Assunto:</td>
          <td style="padding: 8px;">${dadosHtml.assunto || '-'}</td>
        </tr>
        <tr>
          <td style="padding: 8px; font-weight: bold;">Mensagem:</td>
          <td style="padding: 8px;">${dadosHtml.mensagem || '-'}</td>
        </tr>
      </table>
    </div>
  `;
